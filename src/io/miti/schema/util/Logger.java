...
public final class Logger
{
  ...
  /**
   * Store a message handler.
   */
  private transient MessageHandler handler = null;
   ...
   * 
   * @param pHandler the message handler to save
   */
  public static void setHandler(final MessageHandler pHandler)
  {
    logger.handler = pHandler;
  }
